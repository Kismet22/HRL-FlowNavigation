...
def train(model_id, render_mode=None, checkpoint_path_high=None, checkpoint_path_low=None):
    ...
    if _is_head:
        ...
        if theta_mode:
            ...
            if not _near_mode:
                env_name = f'train_5_dim_{state_dim_mode}_small_scale'
            else:
    ...
    _forward_only=_is_head, _obstacle_avoid=True, _theta_mode = theta_mode, _is_switch=switch_mode, u_clip=clip_max, v_clip=clip_max, _near_mode=_near_mode, _fov=_fov)
